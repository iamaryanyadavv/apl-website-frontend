...
export default function Games(){
    ...
    async function getGames(){
        ...
        await fetch('https://aplapi.onrender.com/seasons/apl7/games')
                                        ...
                                        {Day1Games.map((game,index)=>(
                                            ...
                                            css={{
                                                ...
                                                <Card isHoverable css={{ mw: "max-content" }}>
                                                    ...
                                                    <Card.Body css={{ py: "$10" }}>
                                                        ...
                                                        css={{
                                                            ...
                                                            css={{
                                                                ...
                                                                <Text 
                                                                css={{
                                                                    fontSize: game[3]==='Rescheduled' ?'$lg':'$2xl',
                                                                    fontWeight: game[3]==='Rescheduled' ? '$medium' : '$semibold',
                                                                    padding: game[3]==='Rescheduled' ?'6px 10px':'0px 10px',
                                                                    display: 'inline',
                                                                    color: game[3]==='Rescheduled' ? '$gray600' : 'white'
                                                                }}>
                                                                    {game[3]}
                                                                </Text>
                                                            </Grid>
                                                    ...
                                                    <Card.Footer>
                                                        {game[0]!='12:00 AM' && 
                                                            <Text b>April 18th Thursday {game[0]}</Text>
                                                        }
                                                        {game[0]=='12:00 AM' &&
                                                            <Text b>April 19th Friday {game[0]}</Text>
                                                        }
                                                    </Card.Footer>
                                                </Card>
                                            </Grid>
